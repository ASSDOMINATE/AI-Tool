package cn.hoxinte.ai.common.helper;

import cn.hoxinte.ai.common.enums.ChatFailedType;
import cn.hoxinte.ai.common.enums.ChatRoleType;
import cn.hoxinte.ai.common.enums.ExceptionType;
import cn.hoxinte.ai.common.enums.GptModelType;
import cn.hoxinte.ai.common.utils.ChatTokenUtil;
import cn.hoxinte.ai.entity.dto.ChatDTO;
import cn.hoxinte.ai.entity.dto.ChatGroupDTO;
import cn.hoxinte.ai.entity.dto.ContentDTO;
import cn.hoxinte.ai.entity.dto.ReplyDTO;
import cn.hoxinte.ai.sys.exception.BusinessException;
...
public final class ChatGptHelper {
     ...
     * @return AI回复
     */
    public static ReplyDTO send(SseEmitter sseEmitter, ChatDTO chat) {
        return send(sseEmitter, chat.getContentList(), chat.getApiKey(), chat.getSentence(), chat.getSystem(), chat.getModelId(), chat.getMaxResultTokens(), chat.getTemperature());
    }
